...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Okt 2020 pada 15.38
...
INSERT INTO `mhs` (`id_mhs`, `nm_mhs`, `npm`, `jk`, `id_kelas`, `email`) VALUES
(4, 'Gede Satriadi Utama', '12345678', '', 2, 'satriadiutama@yahoo.com'),
(5, 'Sabrina Tiara Fatiha', '12345679', 'Perempuan', 2, 'sabrina@yahoo.com'),
(6, 'Alex', '12121212', 'Laki-Laki', 4, 'Alex@yahoo.com'),
